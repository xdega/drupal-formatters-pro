 ...
 *
 * @FieldFormatter(
 *   id = "field_formatter_slugify",
 *   label = @Translation("Convert text to Slug"),
 *   field_types = {
 *     "string",
 *     "text",
 *   }
 * )
 */
class SlugifyTextFormatter extends FormatterBase implements ContainerFactoryPluginInterface
{
  /**
  ...
  public function viewElements(FieldItemListInterface $items, $langcode)
  {
    ...
    foreach ($items as $index => $item) {
      ...
      $result = $this->stringManipulator->slugify($value);
